    ...
    return (
        <section id="about" className="mx-auto pr-8 pl-8 px-4 py-16">
            <div className="grid items-center gap-10 md:grid-cols-2">
                <motion.div className="flex flex-col gap-3" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8, ease: "easeOut" }}>
